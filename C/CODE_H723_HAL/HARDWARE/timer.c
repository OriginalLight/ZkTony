...
void STEPMOTOR_GPIO_Init()
{
    ...
    // HAL_GPIO_WritePin(GPIOC,(GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15),GPIO_PIN_RESET);//默认设置为顺时针方向
    ...
    // HAL_GPIO_WritePin(GPIOA, (GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6), GPIO_PIN_RESET); // 默认设置为顺时针方向
    ...
    // HAL_GPIO_WritePin(GPIOE,(GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6),GPIO_PIN_RESET);//默认设置为顺时针方向
...
void STEPMOTOR_TIMx_Init()
{
    ...
    /* 定时器基本环境配置 */
    htimx_STEPMOTOR.Instance = TIM1;                             // 定时器编号
    htimx_STEPMOTOR.Init.Prescaler = STEPMOTOR_TIM_PRESCALER;    // 定时器预分频器
    htimx_STEPMOTOR.Init.CounterMode = TIM_COUNTERMODE_UP;       // 计数方向：向上计数
    htimx_STEPMOTOR.Init.Period = STEPMOTOR_TIM_PERIOD;          // 定时器周期
    htimx_STEPMOTOR.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1; // 时钟分频
    ...
    /* 定时器基本环境配置 */
    htimx_STEPMOTOR.Instance = TIM2;                             // 定时器编号
    htimx_STEPMOTOR.Init.Prescaler = STEPMOTOR_TIM_PRESCALER;    // 定时器预分频器
    htimx_STEPMOTOR.Init.CounterMode = TIM_COUNTERMODE_UP;       // 计数方向：向上计数
    htimx_STEPMOTOR.Init.Period = STEPMOTOR_TIM_PERIOD;          // 定时器周期
    htimx_STEPMOTOR.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1; // 时钟分频
    ...
    /* 定时器基本环境配置 */
    htimx_STEPMOTOR.Instance = TIM3;                             // 定时器编号
    htimx_STEPMOTOR.Init.Prescaler = STEPMOTOR_TIM_PRESCALER;    // 定时器预分频器
    htimx_STEPMOTOR.Init.CounterMode = TIM_COUNTERMODE_UP;       // 计数方向：向上计数
    htimx_STEPMOTOR.Init.Period = STEPMOTOR_TIM_PERIOD;          // 定时器周期
    htimx_STEPMOTOR.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1; // 时钟分频
...
//-------------------------------------------------------------------------
// 通用定时器中断初始化,定时器在APB1上，APB1的定时器时钟为200MHz
// arr：自动重装值。
// psc：时钟预分频数
