...
public class VisionHelper
{
    ...
    public static bool FrameProc(IntPtr pFrameInShort, ushort iFrameID, int iFrameWidth, int iFrameHeight, IntPtr pParam)
    {
        ...
        var frameSizeInByte = iFrameWidth * iFrameHeight * 2;
        var fileName = $"frame_{iFrameID.ToString()}.raw";
        var fileStream = new FileStream(fileName, FileMode.Create, FileAccess.Write);
        WriteFile(fileStream, pFrameInShort, frameSizeInByte, out _, IntPtr.Zero);
        fileStream.Close();
        //Returnning 'false' means this function will not be called again
        return false;
        //Returning 'true' means this function will be called next
        //return true;
    }

    public static FrameProcCbFunc GetFrameProcCbFunc()
    {
        return new FrameProcCbFunc(FrameProc);
    }
