...
//                            index = 1,
//                            pdv = 67L,
//                            ads = Triple(314, 314, 314),
//                        )
//
//                        with(
//                            index = 2,
//                            pdv = 12800L,
//                            ads = Triple(120000, 120000, 600 * 100),
//
//                            )
//                    }
                        ...
                        if (!getGpio(2)) {
                            start {
                                ...
                                with(
                                    index = 1,
                                    pdv = 310000L,
                                    ads = Triple(300 * 100, 1200, 1200 * 100),
                                )
                            }
                            start {
                                timeOut = 1000L * 30
                            ...
                            start {
                                ...
                                with(
                                    index = 1,
                                    pdv = 9600L,
                                    ads = Triple(100 * 100, 1200, 1200 * 100),
                                )
                            }
                    ...
                    gpio(0, 1)
                    delay(500L)
                    println("x轴光电状态====0号光电===" + getGpio(0) + "====1号光电===" + getGpio(1))
                    if (!getGpio(0) && !getGpio(1)) {
                        ...
                        start {
                            ...
                            with(
                                index = 0,
                                pdv = -64000L,
                                ads = Triple(300 * 100, 1200, 600 * 100),
                        ...
                        start {
                            ...
                            with(
                                index = 0,
                                pdv = -6500L,
                                ads = Triple(100 * 100, 1200, 200 * 100),
                            )
                        }
                        gpio(0)
                        delay(500L)
...
//            val ordinate = dataStore.readData(Constants.ZT_0004, 0.0)
            ...
            _job.value = launch {
                try {
                    ...
                    println("===废液槽运动结束===")
                    val feiyebushu =
                        pulse(index = 0, dvp = wastePosition)
                    println("废液槽步数===" + feiyebushu)
...
//                        println("s2=====$s2")
                        println("ad=====$ad")
//                        with(index = 1, pdv = p1, ads = Triple(ad, s.toLong() * 10, s.toLong()))
//
//                        with(index = 2, pdv = p2, ads = Triple(ad, s.toLong() * 10, s.toLong()))
...
//                    delay(20)
                    ...
                    start {
                        timeOut = 1000L * 60 * 10
                        val s = speed.toDouble()
                        val p1 = pulse(index = 1, dvp = coagulantVol)
                        val p2 = pulse(index = 2, dvp = volumeVol)
                        val p3 = pulse(index = 3, dvp = volumeVol)
...
//                        start {
//                            timeOut = 1000L * 60
//                            with(index = 2, pdv = coagulantpulse)
//                        }
//                    }
                } catch (ex: Exception) {
                    ex.printStackTrace()
