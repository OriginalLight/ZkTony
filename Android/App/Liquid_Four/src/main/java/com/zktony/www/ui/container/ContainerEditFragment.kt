                    ...
                    CustomDialog.build()
                        .setCustomView(object :
                            ...
                            override fun onBind(dialog: CustomDialog, v: View) {
                                ...
                                inputX.setText(con?.x?.toString() ?: "")
                                inputY.setText(con?.y?.toString() ?: "")
            ...
            .setCustomView(object :
                ...
                override fun onBind(dialog: CustomDialog, v: View) {
                    ...
                    c1?.let {
                        ...
                        inputX.setText(xy?.xAxis?.removeZero() ?: "")
                        inputY.setText(xy?.yAxis?.removeZero() ?: "")
                    }
