...
enum class Product(val count: Int, val resId: Int, val text: String) {
    M_BLOT_T4000(4, R.string.app_type_0, "M-Blot T4000"),
    M_BLOT_T4100(4, R.string.app_type_1, "M-Blot T4100"),
    M_BLOT_T4200(4, R.string.app_type_2, "M-Blot T4200"),
    M_BLOT_T2000(2, R.string.app_type_0, "M-Blot T2000"),
    M_BLOT_T2100(2, R.string.app_type_1, "M-Blot T2100"),
    M_BLOT_T2200(2, R.string.app_type_2, "M-Blot T2200");
