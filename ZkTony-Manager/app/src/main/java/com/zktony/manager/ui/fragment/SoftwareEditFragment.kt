...
fun SoftwareEditFragment(
    ...
    val software = uiState.software ?: software { }
            ...
            item {
                if (uiState.software == null) {
                    Button(modifier = Modifier
                        .fillMaxWidth()
                        .padding(top = 16.dp),
                        enabled = mPackage.value.isNotEmpty() && mVersionName.value.isNotEmpty() && mBuildType.value.isNotEmpty(),
                        onClick = {
                            navigateTo(ManagerPageEnum.SOFTWARE_LIST)
