...
export default {
  ...
  'settings.system.sound.title': 'Sound Mode',
  'settings.system.sound.0': 'Mute Mode',
  'settings.system.sound.1': 'Ring Mode',
  'settings.system.sound.2': 'Voice Mode',
  ...
  'settings.system.update.check': 'Check Update',
