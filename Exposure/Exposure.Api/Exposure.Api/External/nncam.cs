...
internal class Nncam : IDisposable
{
    ...
    */
    public bool get_PixelFormatSupport(sbyte cmd, out int iValue)
    {
        ...
        return CheckHResult(Nncam_get_PixelFormatSupport(handle_, cmd, out iValue));
    }
    ...
    */
    ...
    public bool IoControl(uint ioLineNumber, eIoControType eType, int outVal, out int inVal)
    {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Nncam_IoControl(handle_, ioLineNumber, eType, outVal, out inVal));
    }
    ...
    public bool get_AfParam(out AfParam pAfParam)
    {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Nncam_get_AfParam(handle_, out pAfParam));
    }
    ...
    */
    ...
    {
        IntPtr ptr = Nncam_get_PixelFormatName(val);
        if (IntPtr.Zero == ptr)
            return null;
    ...
    */
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete("Use Nncam_EnumV2")]
