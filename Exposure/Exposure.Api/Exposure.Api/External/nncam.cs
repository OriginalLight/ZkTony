...
internal class Nncam : IDisposable
{
    ...
    public enum eFLAG : ulong
    {
        ...
        FLAG_TEC_ONOFF =
            0x00020000, /* Thermoelectric Cooler can be turn on or off, support to set the target temperature of TEC */
        ...
        FLAG_DDR =
            0x02000000, /* use very large capacity DDR (Double Data Rate SDRAM) for frame buffer. The capacity is not less than one full frame */
        ...
        [Obsolete("Use FLAG_RAW10")] FLAG_BITDEPTH10 = FLAG_RAW10, /* obsolete, same as FLAG_RAW10 */
        [Obsolete("Use FLAG_RAW12")] FLAG_BITDEPTH12 = FLAG_RAW12, /* obsolete, same as FLAG_RAW12 */
        [Obsolete("Use FLAG_RAW14")] FLAG_BITDEPTH14 = FLAG_RAW14, /* obsolete, same as FLAG_RAW14 */
        [Obsolete("Use FLAG_RAW16")] FLAG_BITDEPTH16 = FLAG_RAW16, /* obsolete, same as FLAG_RAW16 */
        ...
        FLAG_PRECISE_FRAMERATE =
            0x0000004000000000, /* support precise framerate & bandwidth, see OPTION_PRECISE_FRAMERATE & OPTION_BANDWIDTH */
        ...
        FLAG_SELFTRIGGER = 0x0040000000000000, /* self trigger */
        FLAG_RAW11 = 0x0080000000000000, /* pixel format, RAW 11bits */
        FLAG_GHOPTO = 0x0100000000000000 /* ghopto sensor */
    }
    ...
    {
        OPTION_NOFRAME_TIMEOUT =
            0x01, /* no frame timeout: 0 => disable, positive value (>= NOFRAME_TIMEOUT_MIN) => timeout milliseconds. default: disable */
        ...
        OPTION_RAW =
            0x04, /* raw data mode, read the sensor "raw" data. This can be set only while camea is NOT running. 0 = rgb, 1 = raw, default value: 0 */
        ...
        OPTION_LINEAR =
            0x09, /* 0 = turn off the builtin linear tone mapping, 1 = turn on the builtin linear tone mapping, default value: 1 */

        OPTION_CURVE =
            0x0a, /* 0 = turn off the builtin curve tone mapping, 1 = turn on the builtin polynomial curve tone mapping, 2 = logarithmic curve tone mapping, default value: 2 */

        OPTION_TRIGGER =
            0x0b, /* 0 = video mode, 1 = software or simulated trigger mode, 2 = external trigger mode, 3 = external + software trigger, default value = 0 */

        OPTION_RGB =
            0x0c, /* 0 => RGB24; 1 => enable RGB48 format when bitdepth > 8; 2 => RGB32; 3 => 8 Bits Grey (only for mono camera); 4 => 16 Bits Grey (only for mono camera when bitdepth > 8); 5 => RGB64 */
        ...
        OPTION_TECTARGET =
            0x0f, /* get or set the target temperature of the thermoelectric cooler, in 0.1 degree Celsius. For example, 125 means 12.5 degree Celsius, -35 means -3.5 degree Celsius */
        ...
        OPTION_DEMOSAIC =
            0x12, /* demosaic method for both video and still image: BILINEAR = 0, VNG(Variable Number of Gradients) = 1, PPG(Patterned Pixel Grouping) = 2, AHD(Adaptive Homogeneity Directed) = 3, EA(Edge Aware) = 4, see https://en.wikipedia.org/wiki/Demosaicing, default value: 0 */
        ...
        OPTION_CG = 0x19, /* Conversion Gain:
                                                           0 = LCG
                                                           1 = HCG
        ...
        OPTION_AFFEEDBACK =
            0x27, /* auto focus information feedback; 0:unknown; 1:focused; 2:focusing; 3:defocus; 4:up; 5:down */
        ...
        OPTION_BYTEORDER =
            0x2a, /* Byte order, BGR or RGB: 0 => RGB, 1 => BGR, default value: 1(Win), 0(macOS, Linux, Android) */

        OPTION_NOPACKET_TIMEOUT =
            0x2b, /* no packet timeout: 0 => disable, positive value (>= NOPACKET_TIMEOUT_MIN) => timeout milliseconds. default: disable */

        OPTION_MAX_PRECISE_FRAMERATE =
            0x2c, /* get the precise frame rate maximum value in 0.1 fps, such as 115 means 11.5 fps. E_NOTIMPL means not supported */
        ...
        OPTION_FRONTEND_DEQUE_LENGTH = 0x31, /* frontend (raw) frame buffer deque length, range: [2, 1024], default: 4
                                                    ...
                                                    */
        OPTION_FRAME_DEQUE_LENGTH = 0x31, /* alias of NNCAM_OPTION_FRONTEND_DEQUE_LENGTH */

        OPTION_MIN_PRECISE_FRAMERATE =
            0x32, /* get the precise frame rate minimum value in 0.1 fps, such as 15 means 1.5 fps */
        OPTION_SEQUENCER_ONOFF = 0x33, /* sequencer trigger: on/off */
        OPTION_SEQUENCER_NUMBER = 0x34, /* sequencer trigger: number, range = [1, 255] */

        OPTION_SEQUENCER_EXPOTIME =
            0x01000000, /* sequencer trigger: exposure time, iOption = OPTION_SEQUENCER_EXPOTIME | index, iValue = exposure time
        ...
        OPTION_SEQUENCER_EXPOGAIN =
            0x02000000, /* sequencer trigger: exposure gain, iOption = OPTION_SEQUENCER_EXPOGAIN | index, iValue = gain */
        ...
        OPTION_NUMBER_DROP_FRAME =
            0x3e, /* get the number of frames that have been grabbed from the USB but dropped by the software */
        ...
        OPTION_BACKEND_DEQUE_LENGTH =
            0x41, /* backend (pipelined) frame buffer deque length (Only available in pull mode), range: [2, 1024], default: 3
                                                            All the memory will be pre-allocated when the camera starts, so, please attention to memory usage
                                                         */
        ...
        OPTION_HEARTBEAT =
            0x44, /* Heartbeat interval in millisecond, range = [HEARTBEAT_MIN, HEARTBEAT_MAX], 0 = disable, default: disable */
        ...
        OPTION_EVENT_HARDWARE =
            0x04000000, /* enable or disable hardware event: 0 => disable, 1 => enable; default: disable
        ...
        OPTION_GIGETIMEOUT =
            0x5a, /* For GigE cameras, the application periodically sends heartbeat signals to the camera to keep the connection to the camera alive.
        ...
        OPTION_ISP =
            0x5f, /* Enable hardware ISP: 0 => auto (disable in RAW mode, otherwise enable), 1 => enable, -1 => disable; default: 0 */
        ...
        OPTION_PSEUDO_COLOR_ENABLE = 0x65, /* Pseudo: -1 => custom: use startcolor & endcolor to generate the colormap
                                                                ...
                                                                23 => turbo
                                                     */
        OPTION_LOW_POWERCONSUMPTION = 0x66 /* Low Power Consumption: 0 => disable, 1 => enable */
    }
    ...
    public const int
        E_PENDING = unchecked((int)0x8000000a); /* The data necessary to complete this operation is not yet available */

    public const int
        E_TIMEOUT = unchecked((int)0x8001011f); /* This operation returned because the timeout period expired */
    ...
    public enum ePIXELFORMAT : uint
    {
        ...
        PIXELFORMAT_HDR8HL = 0x0e, /* HDR, Bitdepth: 8, Conversion Gain: High + Low */
        PIXELFORMAT_HDR10HL = 0x0f, /* HDR, Bitdepth: 10, Conversion Gain: High + Low */
        PIXELFORMAT_HDR11HL = 0x10, /* HDR, Bitdepth: 11, Conversion Gain: High + Low */
        PIXELFORMAT_HDR12HL = 0x11, /* HDR, Bitdepth: 12, Conversion Gain: High + Low */
        PIXELFORMAT_HDR14HL = 0x12 /* HDR, Bitdepth: 14, Conversion Gain: High + Low */
    }
    ...
    {
        IOCONTROLTYPE_GET_SUPPORTEDMODE =
            0x01, /* 0x01 => Input, 0x02 => Output, (0x01 | 0x02) => support both Input and Output */
        ...
        IOCONTROLTYPE_GET_INPUTACTIVATION =
            0x09, /* 0x00 => Rising edge, 0x01 => Falling edge, 0x02 => Level high, 0x03 => Level low */
        ...
        IOCONTROLTYPE_GET_STROBEDELAYMODE =
            0x21, /* boolean, 1 => delay, 0 => pre-delay; compared to exposure active signal */
        IOCONTROLTYPE_SET_STROBEDELAYMODE = 0x22,

        IOCONTROLTYPE_GET_STROBEDELAYTIME =
            0x23, /* Strobe delay or pre-delay time in microseconds, range: [0, 5000000] */
        ...
        IOCONTROLTYPE_GET_UART_BAUDRATE =
            0x2b, /* baud rate: 0 => 9600; 1 => 19200; 2 => 38400; 3 => 57600; 4 => 115200 */
        ...
        IOCONTROLTYPE_GET_EXPO_ACTIVE_MODE =
            0x2f, /* exposure time signal: 0 => specified line, 1 => common exposure time */
    ...
    public enum eAAF
    {
        ...
        AAF_GETTEMP = 0x14, /* in 0.1 degrees Celsius, such as: 32 means 3.2 degrees Celsius */
        AAF_ISMOVING = 0x16,
        AAF_HALT = 0x17,
        AAF_SETMAXSTEP = 0x1b,
        AAF_GETMAXSTEP = 0x1c,
    ...
    public struct ModelV2
    {
        ...
        public ulong flag; /* NNCAM_FLAG_xxx, 64 bits */

        public uint
            maxspeed; /* number of speed level, same as get_MaxSpeed(), the speed range = [0, maxspeed], closed interval */
    ...
    /* get the version of this dll/so, which is: 55.24239.20231224 */
    ...
    {
        var p = Marshal.AllocHGlobal(512 * 128);
    ...
    public static int GigeEnable(DelegateHotplug funHotplug)
    {
        HOTPLUG_CALLBACK pHotplug = delegate(IntPtr ctxHotplug)
        {
            ...
            {
                var p = obj as DelegateHotplug;
                if (p != null)
                    p();
            }
        };
        var id = new IntPtr(Interlocked.Increment(ref sid_));
    ...
    public static Device[] Enum()
    {
        var p = Marshal.AllocHGlobal(512 * 128);
        var ti = p;
        var cnt = Nncam_Enum(p);
        var arr = new Device[cnt];
        if (cnt > 0)
            for (uint i = 0; i < cnt; ++i)
            {
                if (IsUnicode())
...

                {
                    ...
                    var resn = Math.Max(arr[i].model.preview, arr[i].model.still);
    ...
    */
    ...
    {
        var tmphandle = Nncam_Open(camId);
    ...
    */
    ...
    {
        var tmphandle = Nncam_OpenByIndex(index);
        if (tmphandle == null || tmphandle.IsInvalid || tmphandle.IsClosed)
            return null;
        return new Nncam(tmphandle);
    }

    public SafeCamHandle Handle { get; }
    ...
    public uint ResolutionNumber
    {
        get
        {
            if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
                return 0;
            return Nncam_get_ResolutionNumber(Handle);
        }
    }
    ...
    public uint StillResolutionNumber
    {
        get
        {
            if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
                return 0;
            return Nncam_get_StillResolutionNumber(Handle);
        }
    }
    ...
    public bool MonoMode
    {
        get
        {
            if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
                return false;
            return 0 == Nncam_get_MonoMode(Handle);
        }
    }
    ...
    public uint MaxSpeed
    {
        get
        {
            if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
                return 0;
            return Nncam_get_MaxSpeed(Handle);
        }
    }
    ...
    public uint MaxBitDepth
    {
        get
        {
            if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
                return 0;
            return Nncam_get_MaxBitDepth(Handle);
        }
    }
    ...
    public uint FanMaxSpeed
    {
        get
        {
            if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
                return 0;
            return Nncam_get_FanMaxSpeed(Handle);
        }
    }
    ...
    public ushort Revision
    {
        get
        {
            ...
            if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
                return rev;
            Nncam_get_Revision(Handle, out rev);
            return rev;
        }
    }
    ...
    public string SerialNumber
    {
        get
        {
            ...
            if (Nncam_get_SerialNumber(Handle, ptr) >= 0)
    ...
    public string FwVersion
    {
        get
        {
            ...
            if (Nncam_get_FwVersion(Handle, ptr) >= 0)
                str = Marshal.PtrToStringAnsi(ptr);
            Marshal.FreeHGlobal(ptr);
            return str;
        }
    ...
    public string HwVersion
    {
        get
        {
            ...
            if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
                return str;
            var ptr = Marshal.AllocHGlobal(32);
            if (Nncam_get_HwVersion(Handle, ptr) >= 0)
                str = Marshal.PtrToStringAnsi(ptr);
            Marshal.FreeHGlobal(ptr);
            return str;
        }
    ...
    public string ProductionDate
    {
        get
        {
            ...
            if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
                return str;
            var ptr = Marshal.AllocHGlobal(32);
            if (Nncam_get_ProductionDate(Handle, ptr) >= 0)
                str = Marshal.PtrToStringAnsi(ptr);
            Marshal.FreeHGlobal(ptr);
            return str;
        }
    ...
    public string FpgaVersion
    {
        get
        {
            ...
            if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
                return str;
            var ptr = Marshal.AllocHGlobal(32);
            if (Nncam_get_FpgaVersion(Handle, ptr) >= 0)
                str = Marshal.PtrToStringAnsi(ptr);
            Marshal.FreeHGlobal(ptr);
            return str;
        }
    ...
    public bool StartPullModeWithWndMsg(IntPtr hWnd, uint nMsg)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_StartPullModeWithWndMsg(Handle, hWnd, nMsg));
    }
#endif
    ...
    public bool StartPullModeWithCallback(DelegateEventCallback funEvent)
    {
        ...
        if (funEvent != null)
        {
            pEvent_ = EventCallback;
            return CheckHResult(Nncam_StartPullModeWithCallback(Handle, pEvent_, id_));
        }

        return CheckHResult(Nncam_StartPullModeWithCallback(Handle, null, IntPtr.Zero));
    }
    ...
    public bool PullImage(IntPtr pImageData, int bits, out uint pnWidth, out uint pnHeight)
    {
        ...
        return CheckHResult(Nncam_PullImage(Handle, pImageData, bits, out pnWidth, out pnHeight));
    }
    ...
    public bool PullImageV2(IntPtr pImageData, int bits, out FrameInfoV2 pInfo)
    {
        ...
        return CheckHResult(Nncam_PullImageV2(Handle, pImageData, bits, out pInfo));
    }
    ...
    public bool PullStillImage(IntPtr pImageData, int bits, out uint pnWidth, out uint pnHeight)
    {
        ...
        return CheckHResult(Nncam_PullStillImage(Handle, pImageData, bits, out pnWidth, out pnHeight));
    }
    ...
    public bool PullStillImageV2(IntPtr pImageData, int bits, out FrameInfoV2 pInfo)
    {
        ...
        return CheckHResult(Nncam_PullStillImageV2(Handle, pImageData, bits, out pInfo));
    }
    ...
    */
    public bool PullImageV3(IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo)
    {
        ...
        return CheckHResult(Nncam_PullImageV3(Handle, pImageData, bStill, bits, rowPitch, out pInfo));
    }
    ...
    public bool WaitImageV3(uint nWaitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo)
    {
        ...
        return CheckHResult(Nncam_WaitImageV3(Handle, nWaitMS, pImageData, bStill, bits, rowPitch, out pInfo));
    }
    ...
    public bool WaitImageV3(uint nWaitMS, ushort[] pImageData, int bStill, int bits, int rowPitch,
        out FrameInfoV3 pInfo)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
        {
            zeroInfo(out pInfo);
    ...
    public bool PullImageWithRowPitch(IntPtr pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight)
    {
        ...
        return CheckHResult(Nncam_PullImageWithRowPitch(Handle, pImageData, bits, rowPitch, out pnWidth, out pnHeight));
    }
    ...
    public bool PullImageWithRowPitchV2(IntPtr pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo)
    {
        ...
        return CheckHResult(Nncam_PullImageWithRowPitchV2(Handle, pImageData, bits, rowPitch, out pInfo));
    }
    ...
    public bool PullStillImageWithRowPitch(IntPtr pImageData, int bits, int rowPitch, out uint pnWidth,
        out uint pnHeight)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
        {
        ...
        return CheckHResult(Nncam_PullStillImageWithRowPitch(Handle, pImageData, bits, rowPitch, out pnWidth,
            out pnHeight));
    }

    public bool PullStillImageWithRowPitch(byte[] pImageData, int bits, int rowPitch, out uint pnWidth,
        out uint pnHeight)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
        {
    ...
    public bool PullStillImageWithRowPitch(ushort[] pImageData, int bits, int rowPitch, out uint pnWidth,
        out uint pnHeight)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
        {
    ...
    public bool PullStillImageWithRowPitchV2(IntPtr pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo)
    {
        ...
        return CheckHResult(Nncam_PullStillImageWithRowPitchV2(Handle, pImageData, bits, rowPitch, out pInfo));
    }
    ...
    public bool StartPushModeV4(DelegateDataCallbackV4 funData, DelegateEventCallback funEvent)
    {
        ...
        pDataV4_ = delegate(IntPtr pData, IntPtr pInfo, bool bSnap, IntPtr ctxData)
        {
            ...
            {
                var pthis = obj as Nncam;
                if (pthis != null)
                    pthis.DataCallbackV4(pData, pInfo, bSnap);
            }
        };
        pEvent_ = EventCallback;
        return CheckHResult(Nncam_StartPushModeV4(Handle, pDataV4_, id_, pEvent_, id_));
    }
    ...
    public bool StartPushModeV3(DelegateDataCallbackV3 funData, DelegateEventCallback funEvent)
    {
        ...
        pEvent_ = EventCallback;
        return CheckHResult(Nncam_StartPushModeV3(Handle, pDataV3_, id_, pEvent_, id_));
    }
    ...
    public bool Stop()
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_Stop(Handle));
    }
    ...
    public bool Pause(bool bPause)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_Pause(Handle, bPause ? 1 : 0));
    }
    ...
    public bool Snap(uint nResolutionIndex)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_Snap(Handle, nResolutionIndex));
    }
    ...
    public bool SnapN(uint nResolutionIndex, uint nNumber)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_SnapN(Handle, nResolutionIndex, nNumber));
    }
    ...
    public bool SnapR(uint nResolutionIndex, uint nNumber)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_SnapR(Handle, nResolutionIndex, nNumber));
    }
    ...
    */
    public bool Trigger(ushort nNumber)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_Trigger(Handle, nNumber));
    }
    ...
    */
    public bool TriggerSync(uint nTimeout, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo)
    {
        ...
        return CheckHResult(Nncam_TriggerSync(Handle, nTimeout, pImageData, bits, rowPitch, out pInfo));
    }
    ...
    public bool put_Size(int nWidth, int nHeight)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Size(Handle, nWidth, nHeight));
    }
    ...
    public bool get_Size(out int nWidth, out int nHeight)
    {
        ...
        return CheckHResult(Nncam_get_Size(Handle, out nWidth, out nHeight));
    }
    ...
    */
    public bool put_eSize(uint nResolutionIndex)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_eSize(Handle, nResolutionIndex));
    }
    ...
    public bool get_eSize(out uint nResolutionIndex)
    {
        ...
        return CheckHResult(Nncam_get_eSize(Handle, out nResolutionIndex));
    }
    ...
    */
    public bool get_FinalSize(out int nWidth, out int nHeight)
    {
        ...
        return CheckHResult(Nncam_get_FinalSize(Handle, out nWidth, out nHeight));
    }
    ...
    public bool get_Resolution(uint nResolutionIndex, out int pWidth, out int pHeight)
    {
        ...
        return CheckHResult(Nncam_get_Resolution(Handle, nResolutionIndex, out pWidth, out pHeight));
    }
    ...
    */
    public bool get_PixelSize(uint nResolutionIndex, out float x, out float y)
    {
        ...
        return CheckHResult(Nncam_get_PixelSize(Handle, nResolutionIndex, out x, out y));
    }
    ...
    */
    public bool get_ResolutionRatio(uint nResolutionIndex, out int pNumerator, out int pDenominator)
    {
        ...
        return CheckHResult(Nncam_get_ResolutionRatio(Handle, nResolutionIndex, out pNumerator, out pDenominator));
    }
    ...
    */
    public bool get_RawFormat(out uint nFourCC, out uint bitdepth)
    {
        ...
        return CheckHResult(Nncam_get_RawFormat(Handle, out nFourCC, out bitdepth));
    }
    ...
    */
    public bool put_RealTime(int val)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_RealTime(Handle, val));
    }
    ...
    public bool get_RealTime(out int val)
    {
        ...
        return CheckHResult(Nncam_get_RealTime(Handle, out val));
    }
    ...
    public bool Flush()
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_Flush(Handle));
    }
    ...
    public bool get_AutoExpoEnable(out int bAutoExposure)
    {
        ...
        return CheckHResult(Nncam_get_AutoExpoEnable(Handle, out bAutoExposure));
    }
    ...
    public bool put_AutoExpoEnable(int bAutoExposure)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_AutoExpoEnable(Handle, bAutoExposure));
    }
    ...
    public bool get_AutoExpoEnable(out bool bAutoExposure)
    {
        ...
        var iEnable = 0;
        if (!CheckHResult(Nncam_get_AutoExpoEnable(Handle, out iEnable)))
            return false;
    ...
    public bool put_AutoExpoEnable(bool bAutoExposure)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_AutoExpoEnable(Handle, bAutoExposure ? 1 : 0));
    }
    ...
    public bool get_AutoExpoTarget(out ushort Target)
    {
        ...
        return CheckHResult(Nncam_get_AutoExpoTarget(Handle, out Target));
    }
    ...
    public bool put_AutoExpoTarget(ushort Target)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_AutoExpoTarget(Handle, Target));
    }
    ...
    public bool put_AutoExpoRange(uint maxTime, uint minTime, ushort maxGain, ushort minGain)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_AutoExpoRange(Handle, maxTime, minTime, maxGain, minGain));
    }
    ...
    public bool get_AutoExpoRange(out uint maxTime, out uint minTime, out ushort maxGain, out ushort minGain)
    {
        ...
        return CheckHResult(Nncam_get_AutoExpoRange(Handle, out maxTime, out minTime, out maxGain, out minGain));
    }
    ...
    public bool put_MaxAutoExpoTimeAGain(uint maxTime, ushort maxGain)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_MaxAutoExpoTimeAGain(Handle, maxTime, maxGain));
    }
    ...
    public bool get_MaxAutoExpoTimeAGain(out uint maxTime, out ushort maxGain)
    {
        ...
        return CheckHResult(Nncam_get_MaxAutoExpoTimeAGain(Handle, out maxTime, out maxGain));
    }
    ...
    public bool put_MinAutoExpoTimeAGain(uint minTime, ushort minGain)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_MinAutoExpoTimeAGain(Handle, minTime, minGain));
    }
    ...
    public bool get_MinAutoExpoTimeAGain(out uint minTime, out ushort minGain)
    {
        ...
        return CheckHResult(Nncam_get_MinAutoExpoTimeAGain(Handle, out minTime, out minGain));
    }
    ...
    public bool get_ExpoTime(out uint Time) /* in microseconds */
    {
        ...
        return CheckHResult(Nncam_get_ExpoTime(Handle, out Time));
    }
    ...
    public bool put_ExpoTime(uint Time) /* in microseconds */
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_ExpoTime(Handle, Time));
    }
    ...
    public bool get_ExpTimeRange(out uint nMin, out uint nMax, out uint nDef)
    {
        ...
        return CheckHResult(Nncam_get_ExpTimeRange(Handle, out nMin, out nMax, out nDef));
    }
    ...
    public bool get_ExpoAGain(out ushort Gain) /* percent, such as 300 */
    {
        ...
        return CheckHResult(Nncam_get_ExpoAGain(Handle, out Gain));
    }
    ...
    public bool put_ExpoAGain(ushort Gain) /* percent */
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_ExpoAGain(Handle, Gain));
    }
    ...
    public bool get_ExpoAGainRange(out ushort nMin, out ushort nMax, out ushort nDef)
    {
        ...
        return CheckHResult(Nncam_get_ExpoAGainRange(Handle, out nMin, out nMax, out nDef));
    }
    ...
    public bool put_LevelRange(ushort[] aLow, ushort[] aHigh)
    {
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_LevelRange(Handle, aLow, aHigh));
    }
    ...
    public bool get_LevelRange(ushort[] aLow, ushort[] aHigh)
    {
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_get_LevelRange(Handle, aLow, aHigh));
    }

    public bool put_LevelRangeV2(ushort mode, int roiX, int roiY, int roiWidth, int roiHeight, ushort[] aLow,
        ushort[] aHigh)
    {
        if (aLow.Length != 4 || aHigh.Length != 4)
            return false;
        ...
        return CheckHResult(Nncam_put_LevelRangeV2(Handle, mode, ref rc, aLow, aHigh));
    }

    public bool get_LevelRangeV2(out ushort mode, out int roiX, out int roiY, out int roiWidth, out int roiHeight,
        ushort[] aLow, ushort[] aHigh)
    {
        mode = 0;
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        var rc = new RECT();
        if (!CheckHResult(Nncam_get_LevelRangeV2(Handle, out mode, out rc, aLow, aHigh)))
            return false;
        roiX = rc.left;
        roiY = rc.top;
    ...
    public bool put_Hue(int Hue)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Hue(Handle, Hue));
    }
    ...
    public bool get_Hue(out int Hue)
    {
        ...
        return CheckHResult(Nncam_get_Hue(Handle, out Hue));
    }
    ...
    public bool put_Saturation(int Saturation)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Saturation(Handle, Saturation));
    }
    ...
    public bool get_Saturation(out int Saturation)
    {
        ...
        return CheckHResult(Nncam_get_Saturation(Handle, out Saturation));
    }
    ...
    public bool put_Brightness(int Brightness)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Brightness(Handle, Brightness));
    }
    ...
    public bool get_Brightness(out int Brightness)
    {
        ...
        return CheckHResult(Nncam_get_Brightness(Handle, out Brightness));
    }
    ...
    public bool get_Contrast(out int Contrast)
    {
        ...
        return CheckHResult(Nncam_get_Contrast(Handle, out Contrast));
    }
    ...
    public bool put_Contrast(int Contrast)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Contrast(Handle, Contrast));
    }
    ...
    public bool get_Gamma(out int Gamma)
    {
        ...
        return CheckHResult(Nncam_get_Gamma(Handle, out Gamma));
    }
    ...
    public bool put_Gamma(int Gamma)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Gamma(Handle, Gamma));
    }
    ...
    public bool get_Chrome(out bool bChrome) /* monochromatic mode */
    {
        ...
        var iEnable = 0;
        if (!CheckHResult(Nncam_get_Chrome(Handle, out iEnable)))
            return false;
    ...
    public bool put_Chrome(bool bChrome)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Chrome(Handle, bChrome ? 1 : 0));
    }
    ...
    public bool get_VFlip(out bool bVFlip) /* vertical flip */
    {
        ...
        var iVFlip = 0;
        if (!CheckHResult(Nncam_get_VFlip(Handle, out iVFlip)))
            return false;
    ...
    public bool put_VFlip(bool bVFlip)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_VFlip(Handle, bVFlip ? 1 : 0));
    }
    ...
    public bool get_HFlip(out bool bHFlip)
    {
        ...
        var iHFlip = 0;
        if (!CheckHResult(Nncam_get_HFlip(Handle, out iHFlip)))
            return false;
    ...
    public bool put_HFlip(bool bHFlip) /* horizontal flip */
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_HFlip(Handle, bHFlip ? 1 : 0));
    }
    ...
    public bool get_Negative(out bool bNegative)
    {
        ...
        var iNegative = 0;
        if (!CheckHResult(Nncam_get_Negative(Handle, out iNegative)))
            return false;
    ...
    public bool put_Negative(bool bNegative)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Negative(Handle, bNegative ? 1 : 0));
    }
    ...
    public bool put_Speed(ushort nSpeed)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Speed(Handle, nSpeed));
    }
    ...
    public bool get_Speed(out ushort pSpeed)
    {
        ...
        return CheckHResult(Nncam_get_Speed(Handle, out pSpeed));
    }
    ...
    */
    public bool put_HZ(int nHZ)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_HZ(Handle, nHZ));
    }
    ...
    public bool get_HZ(out int nHZ)
    {
        ...
        return CheckHResult(Nncam_get_HZ(Handle, out nHZ));
    }
    ...
    public bool put_Mode(bool bSkip) /* skip or bin */
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Mode(Handle, bSkip ? 1 : 0));
    }
    ...
    public bool get_Mode(out bool bSkip)
    {
        ...
        var iSkip = 0;
        if (!CheckHResult(Nncam_get_Mode(Handle, out iSkip)))
            return false;
    ...
    public bool put_TempTint(int nTemp, int nTint)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_TempTint(Handle, nTemp, nTint));
    }
    ...
    public bool get_TempTint(out int nTemp, out int nTint)
    {
        ...
        return CheckHResult(Nncam_get_TempTint(Handle, out nTemp, out nTint));
    }
    ...
    public bool put_WhiteBalanceGain(int[] aGain)
    {
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_WhiteBalanceGain(Handle, aGain));
    }
    ...
    public bool get_WhiteBalanceGain(int[] aGain)
    {
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_get_WhiteBalanceGain(Handle, aGain));
    }
    ...
    public bool put_AWBAuxRect(int X, int Y, int Width, int Height)
    {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        return CheckHResult(Nncam_put_AWBAuxRect(Handle, ref rc));
    }
    ...
    public bool get_AWBAuxRect(out int X, out int Y, out int Width, out int Height)
    {
        ...
        var rc = new RECT();
        if (!CheckHResult(Nncam_get_AWBAuxRect(Handle, out rc)))
            return false;
    ...
    public bool put_AEAuxRect(int X, int Y, int Width, int Height)
    {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        return CheckHResult(Nncam_put_AEAuxRect(Handle, ref rc));
    }
    ...
    public bool get_AEAuxRect(out int X, out int Y, out int Width, out int Height)
    {
        ...
        var rc = new RECT();
        if (!CheckHResult(Nncam_get_AEAuxRect(Handle, out rc)))
            return false;
    ...
    public bool put_BlackBalance(ushort[] aSub)
    {
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_BlackBalance(Handle, aSub));
    }
    ...
    public bool get_BlackBalance(ushort[] aSub)
    {
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_get_BlackBalance(Handle, aSub));
    }
    ...
    public bool put_ABBAuxRect(int X, int Y, int Width, int Height)
    {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        return CheckHResult(Nncam_put_ABBAuxRect(Handle, ref rc));
    }
    ...
    public bool get_ABBAuxRect(out int X, out int Y, out int Width, out int Height)
    {
        ...
        var rc = new RECT();
        if (!CheckHResult(Nncam_get_ABBAuxRect(Handle, out rc)))
            return false;
    ...
    public bool get_StillResolution(uint nResolutionIndex, out int pWidth, out int pHeight)
    {
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_get_StillResolution(Handle, nResolutionIndex, out pWidth, out pHeight));
    }
    ...
    public bool put_VignetEnable(bool bEnable)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_VignetEnable(Handle, bEnable ? 1 : 0));
    }
    ...
    public bool get_VignetEnable(out bool bEnable)
    {
        ...
        var iEanble = 0;
        if (!CheckHResult(Nncam_get_VignetEnable(Handle, out iEanble)))
            return false;
    ...
    public bool put_VignetAmountInt(int nAmount)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_VignetAmountInt(Handle, nAmount));
    }
    ...
    public bool get_VignetAmountInt(out int nAmount)
    {
        ...
        return CheckHResult(Nncam_get_VignetAmountInt(Handle, out nAmount));
    }
    ...
    public bool put_VignetMidPointInt(int nMidPoint)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_VignetMidPointInt(Handle, nMidPoint));
    }
    ...
    public bool get_VignetMidPointInt(out int nMidPoint)
    {
        ...
        return CheckHResult(Nncam_get_VignetMidPointInt(Handle, out nMidPoint));
    }
    ...
    */
    public bool put_LEDState(ushort iLed, ushort iState, ushort iPeriod)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_LEDState(Handle, iLed, iState, iPeriod));
    }
    ...
    public int write_EEPROM(uint addr, IntPtr pBuffer, uint nBufferLen)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return E_UNEXPECTED;
        return Nncam_write_EEPROM(Handle, addr, pBuffer, nBufferLen);
    }
    ...
    public int write_EEPROM(uint addr, byte[] pBuffer)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return E_UNEXPECTED;
        return Nncam_write_EEPROM(Handle, addr, pBuffer, pBuffer.Length);
    }
    ...
    public int read_EEPROM(uint addr, IntPtr pBuffer, uint nBufferLen)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return E_UNEXPECTED;
        return Nncam_read_EEPROM(Handle, addr, pBuffer, nBufferLen);
    }
    ...
    public int read_EEPROM(uint addr, byte[] pBuffer)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return E_UNEXPECTED;
        return Nncam_read_EEPROM(Handle, addr, pBuffer, pBuffer.Length);
    }
    ...
    */
    public int rwc_Flash(uint action, uint addr, uint len, IntPtr pData)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return E_UNEXPECTED;
        return Nncam_rwc_Flash(Handle, action, addr, len, pData);
    }
    ...
    public int write_Pipe(uint pipeId, IntPtr pBuffer, uint nBufferLen)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return E_UNEXPECTED;
        return Nncam_write_Pipe(Handle, pipeId, pBuffer, nBufferLen);
    }
    ...
    public int read_Pipe(uint pipeId, IntPtr pBuffer, uint nBufferLen)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return E_UNEXPECTED;
        return Nncam_read_Pipe(Handle, pipeId, pBuffer, nBufferLen);
    }
    ...
    public int feed_Pipe(uint pipeId)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return E_UNEXPECTED;
        return Nncam_feed_Pipe(Handle, pipeId);
    }
    ...
    public int write_UART(IntPtr pBuffer, uint nBufferLen)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return E_UNEXPECTED;
        return Nncam_write_UART(Handle, pBuffer, nBufferLen);
    }
    ...
    public int read_UART(IntPtr pBuffer, uint nBufferLen)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return E_UNEXPECTED;
        return Nncam_read_UART(Handle, pBuffer, nBufferLen);
    }
    ...
    public bool put_Option(eOPTION iOption, int iValue)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Option(Handle, iOption, iValue));
    }
    ...
    public bool get_Option(eOPTION iOption, out int iValue)
    {
        ...
        return CheckHResult(Nncam_get_Option(Handle, iOption, out iValue));
    }
     ...
     * iValue: output, NNCAM_PIXELFORMAT_xxxx
     */
    public bool get_PixelFormatSupport(sbyte cmd, out int iValue)
    {
        ...
        return CheckHResult(Nncam_get_PixelFormatSupport(Handle, cmd, out iValue));
    }
    ...
    public bool put_Linear(byte[] v8, ushort[] v16)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Linear(Handle, v8, v16));
    }
    ...
    public bool put_Curve(byte[] v8, ushort[] v16)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Curve(Handle, v8, v16));
    }
    ...
    public bool put_ColorMatrix(double[] v)
    {
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_ColorMatrix(Handle, v));
    }
    ...
    public bool put_InitWBGain(ushort[] v)
    {
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_InitWBGain(Handle, v));
    }
    ...
    public bool get_Temperature(out short pTemperature)
    {
        ...
        return CheckHResult(Nncam_get_Temperature(Handle, out pTemperature));
    }
    ...
    public bool put_Temperature(short nTemperature)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Temperature(Handle, nTemperature));
    }
    ...
    public bool put_Roi(uint xOffset, uint yOffset, uint xWidth, uint yHeight)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_Roi(Handle, xOffset, yOffset, xWidth, yHeight));
    }
    ...
    public bool get_Roi(out uint pxOffset, out uint pyOffset, out uint pxWidth, out uint pyHeight)
    {
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_get_Roi(Handle, out pxOffset, out pyOffset, out pxWidth, out pyHeight));
    }
    ...
    public bool put_XY(int x, int y)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_put_XY(Handle, x, y));
    }
    ...
    */
    public bool get_FrameRate(out uint nFrame, out uint nTime, out uint nTotalFrame)
    {
        ...
        return CheckHResult(Nncam_get_FrameRate(Handle, out nFrame, out nTime, out nTotalFrame));
    }
    ...
    public bool LevelRangeAuto()
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_LevelRangeAuto(Handle));
    }
    ...
    public bool AwbOnce()
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_AwbOnce(Handle, IntPtr.Zero, IntPtr.Zero));
    }
    ...
    public bool AwbInit()
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_AwbInit(Handle, IntPtr.Zero, IntPtr.Zero));
    }
    ...
    public bool AbbOnce()
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_AbbOnce(Handle, IntPtr.Zero, IntPtr.Zero));
    }
    ...
    public bool FfcOnce()
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_FfcOnce(Handle));
    }
    ...
    public bool DfcOnce()
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_DfcOnce(Handle));
    }
    ...
    public bool FfcExport(string filepath)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_FfcExport(Handle, filepath));
    }
    ...
    public bool FfcImport(string filepath)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_FfcImport(Handle, filepath));
    }
    ...
    public bool DfcExport(string filepath)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_DfcExport(Handle, filepath));
    }
    ...
    public bool DfcImport(string filepath)
    {
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_DfcImport(Handle, filepath));
    }
    ...
    public bool IoControl(uint ioLineNumber, eIoControType eType, int outVal, out int inVal)
    {
        ...
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_IoControl(Handle, ioLineNumber, eType, outVal, out inVal));
    }
    ...
    public bool AAF(eAAF action, int outVal, out int inVal)
    {
        ...
        return CheckHResult(Nncam_AAF(Handle, action, outVal, out inVal));
    }
    ...
    {
        pAfParam.idef = pAfParam.imax =
            pAfParam.imin = pAfParam.imaxabs = pAfParam.iminabs = pAfParam.zoneh = pAfParam.zonev = 0;
        if (Handle == null || Handle.IsInvalid || Handle.IsClosed)
            return false;
        return CheckHResult(Nncam_get_AfParam(Handle, out pAfParam));
    }
    ...
    public bool GetHistogram(DelegateHistogramCallback funHistogram)
    {
        ...
        pHistogramV1_ = delegate(IntPtr aHistY, IntPtr aHistR, IntPtr aHistG, IntPtr aHistB, IntPtr ctxHistogramV1)
        {
            ...
            if (map_.TryGetValue(ctxHistogramV1.ToInt32(), out obj) && obj != null)
            {
                ...
                if (pthis != null)
                {
                    ...
                    {
                        var arrHistY = new float[256];
                        var arrHistR = new float[256];
                        var arrHistG = new float[256];
                        var arrHistB = new float[256];
        ...
        return CheckHResult(Nncam_GetHistogram(Handle, pHistogramV1_, id_));
    }
    ...
    public bool GetHistogramV2(DelegateHistogramCallbackV2 funHistogramV2)
    {
        ...
        pHistogramV2_ = delegate(IntPtr aHist, uint nFlag, IntPtr ctxHistogramV2)
        {
            ...
            if (map_.TryGetValue(ctxHistogramV2.ToInt32(), out obj) && obj != null)
            {
                ...
                {
                    var arraySize = 1 << (int)(nFlag & 0x0f);
                    if ((nFlag & 0x00008000) == 0)
                        arraySize *= 3;
                    var arrHist = new int[arraySize];
                    Marshal.Copy(aHist, arrHist, 0, arraySize);
                    pthis.funHistogramV2_(arrHist);
                }
            }
        };
        return CheckHResult(Nncam_GetHistogramV2(Handle, pHistogramV2_, id_));
    }
    ...
    */
    ...
    public static double calcClarityFactorV2(IntPtr pImageData, int bits, uint nImgWidth, uint nImgHeight, uint xOffset,
        uint yOffset, uint xWidth, uint yHeight)
    {
    ...
    /*
        ...
        when nBitDepth > 8
            nBitCount:  24 => RGB24
                        ...
                        64 => RGB64
    */
    public static void deBayerV2(uint nBayer, int nW, int nH, IntPtr input, IntPtr output, byte nBitDepth,
        byte nBitCount)
    {
    ...
    */
    public static int Update(string camId, string filePath, DelegateProgress funProgress)
    {
        ...
        var ret = Nncam_Update(camId, filePath, pProgress, id);
    ...
    private static ModelV2 toModelV2(IntPtr q)
    {
        ...
        if (q != IntPtr.Zero)
        {
            ...
            model.ypixsz = tmp[0];
            q = IncIntPtr(q, sizeof(float));
            var resn = Math.Max(model.preview, model.still);
    ...
    {
        var ptr = Nncam_get_PixelFormatName(val);
        if (IntPtr.Zero == ptr)
            return null;
    ...
    private static int sid_;
    private static readonly Dictionary<int, object> map_ = new();

    private readonly IntPtr id_;
    ...
    */
    ...
    private void DataCallbackV4(IntPtr pData, IntPtr pInfo, bool bSnap)
    {
        if (pData == IntPtr.Zero ||
            pInfo == IntPtr.Zero) /* pData == 0 means that something error, we callback to tell the application */
        {
            if (funDataV4_ != null)
            {
                var info = new FrameInfoV3();
...
#else
            var info = Marshal.PtrToStructure<FrameInfoV3>(pInfo);
#endif
            if (funDataV4_ != null)
...
#else
            var info = Marshal.PtrToStructure<FrameInfoV2>(pInfo);
#endif
            if (funDataV3_ != null)
    ...
    [UnmanagedFunctionPointer(CallingConvention.Winapi)]
    private delegate void HISTOGRAM_CALLBACKV1(IntPtr aHistY, IntPtr aHistR, IntPtr aHistG, IntPtr aHistB,
        IntPtr ctxHistogramV1);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    [return: MarshalAs(ut)]
    private static extern string Nncam_Version();

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    [Obsolete("Use Nncam_EnumV2")]
    ...
    private static extern int
        Nncam_StartPullModeWithCallback(SafeCamHandle h, EVENT_CALLBACK funEvent, IntPtr ctxEvent);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImageV3(SafeCamHandle h, IntPtr pImageData, int bStill, int bits, int rowPitch,
        out FrameInfoV3 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImageV3(SafeCamHandle h, byte[] pImageData, int bStill, int bits, int rowPitch,
        out FrameInfoV3 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImageV3(SafeCamHandle h, ushort[] pImageData, int bStill, int bits,
        int rowPitch, out FrameInfoV3 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_WaitImageV3(SafeCamHandle h, uint nWaitMS, IntPtr pImageData, int bStill, int bits,
        int rowPitch, out FrameInfoV3 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_WaitImageV3(SafeCamHandle h, uint nWaitMS, byte[] pImageData, int bStill, int bits,
        int rowPitch, out FrameInfoV3 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_WaitImageV3(SafeCamHandle h, uint nWaitMS, ushort[] pImageData, int bStill,
        int bits, int rowPitch, out FrameInfoV3 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImage(SafeCamHandle h, IntPtr pImageData, int bits, out uint pnWidth,
        out uint pnHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImage(SafeCamHandle h, byte[] pImageData, int bits, out uint pnWidth,
        out uint pnHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImage(SafeCamHandle h, ushort[] pImageData, int bits, out uint pnWidth,
        out uint pnHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImage(SafeCamHandle h, IntPtr pImageData, int bits, out uint pnWidth,
        out uint pnHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImage(SafeCamHandle h, byte[] pImageData, int bits, out uint pnWidth,
        out uint pnHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImage(SafeCamHandle h, ushort[] pImageData, int bits, out uint pnWidth,
        out uint pnHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImageWithRowPitch(SafeCamHandle h, IntPtr pImageData, int bits, int rowPitch,
        out uint pnWidth, out uint pnHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImageWithRowPitch(SafeCamHandle h, byte[] pImageData, int bits, int rowPitch,
        out uint pnWidth, out uint pnHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImageWithRowPitch(SafeCamHandle h, ushort[] pImageData, int bits, int rowPitch,
        out uint pnWidth, out uint pnHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImageWithRowPitch(SafeCamHandle h, IntPtr pImageData, int bits,
        int rowPitch, out uint pnWidth, out uint pnHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImageWithRowPitch(SafeCamHandle h, byte[] pImageData, int bits,
        int rowPitch, out uint pnWidth, out uint pnHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImageWithRowPitch(SafeCamHandle h, ushort[] pImageData, int bits,
        int rowPitch, out uint pnWidth, out uint pnHeight);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImageV2(SafeCamHandle h, IntPtr pImageData, int bits,
        out FrameInfoV2 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImageV2(SafeCamHandle h, byte[] pImageData, int bits,
        out FrameInfoV2 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImageV2(SafeCamHandle h, ushort[] pImageData, int bits,
        out FrameInfoV2 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImageWithRowPitchV2(SafeCamHandle h, IntPtr pImageData, int bits, int rowPitch,
        out FrameInfoV2 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImageWithRowPitchV2(SafeCamHandle h, byte[] pImageData, int bits, int rowPitch,
        out FrameInfoV2 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullImageWithRowPitchV2(SafeCamHandle h, ushort[] pImageData, int bits,
        int rowPitch, out FrameInfoV2 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImageWithRowPitchV2(SafeCamHandle h, IntPtr pImageData, int bits,
        int rowPitch, out FrameInfoV2 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImageWithRowPitchV2(SafeCamHandle h, byte[] pImageData, int bits,
        int rowPitch, out FrameInfoV2 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_PullStillImageWithRowPitchV2(SafeCamHandle h, ushort[] pImageData, int bits,
        int rowPitch, out FrameInfoV2 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_StartPushModeV4(SafeCamHandle h, DATA_CALLBACK_V4 funData, IntPtr ctxData,
        EVENT_CALLBACK funEvent, IntPtr ctxEvent);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_StartPushModeV3(SafeCamHandle h, DATA_CALLBACK_V3 funData, IntPtr ctxData,
        EVENT_CALLBACK funEvent, IntPtr ctxEvent);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_TriggerSync(SafeCamHandle h, uint nTimeout, IntPtr pImageData, int bits,
        int rowPitch, out FrameInfoV3 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_TriggerSync(SafeCamHandle h, uint nTimeout, byte[] pImageData, int bits,
        int rowPitch, out FrameInfoV3 pInfo);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_TriggerSync(SafeCamHandle h, uint nTimeout, ushort[] pImageData, int bits,
        int rowPitch, out FrameInfoV3 pInfo);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_get_Resolution(SafeCamHandle h, uint nResolutionIndex, out int pWidth,
        out int pHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_get_ResolutionRatio(SafeCamHandle h, uint nResolutionIndex, out int pNumerator,
        out int pDenominator);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_get_Roi(SafeCamHandle h, out uint pxOffset, out uint pyOffset, out uint pxWidth,
        out uint pyHeight);
    ...
    */
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_put_AutoExpoRange(SafeCamHandle h, uint maxTime, uint minTime, ushort maxGain,
        ushort minGain);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_get_AutoExpoRange(SafeCamHandle h, out uint maxTime, out uint minTime,
        out ushort maxGain, out ushort minGain);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_get_ExpoAGainRange(SafeCamHandle h, out ushort nMin, out ushort nMax,
        out ushort nDef);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_put_LevelRangeV2(SafeCamHandle h, ushort mode, ref RECT roiRect, [In] ushort[] aLow,
        [In] ushort[] aHigh);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_get_LevelRangeV2(SafeCamHandle h, out ushort mode, out RECT pRoiRect,
        [Out] ushort[] aLow, [Out] ushort[] aHigh);
    ...
    private static extern uint
        Nncam_get_MaxSpeed(SafeCamHandle h); /* get the maximum speed, "Frame Speed Level", speed range = [0, max] */

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern uint
        Nncam_get_MaxBitDepth(SafeCamHandle h); /* get the max bitdepth of this camera, such as 8, 10, 12, 14, 16 */

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern uint
        Nncam_get_FanMaxSpeed(
            SafeCamHandle h); /* get the maximum fan speed, the fan speed range = [0, max], closed interval */
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_get_StillResolution(SafeCamHandle h, uint nResolutionIndex, out int pWidth,
        out int pHeight);
    ...
    */
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_GetHistogram(SafeCamHandle h, HISTOGRAM_CALLBACKV1 funHistogramV1,
        IntPtr ctxHistogramV1);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_GetHistogramV2(SafeCamHandle h, HISTOGRAM_CALLBACKV2 funHistogramV2,
        IntPtr ctxHistogramV2);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_get_FrameRate(SafeCamHandle h, out uint nFrame, out uint nTime,
        out uint nTotalFrame);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_IoControl(SafeCamHandle h, uint ioLineNumber, eIoControType eType, int outVal,
        out int inVal);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern double Nncam_calc_ClarityFactorV2(IntPtr pImageData, int bits, uint nImgWidth,
        uint nImgHeight, uint xOffset, uint yOffset, uint xWidth, uint yHeight);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern void Nncam_deBayerV2(uint nBayer, int nW, int nH, IntPtr input, IntPtr output, byte nBitDepth,
        byte nBitCount);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_Update([MarshalAs(ut)] string camId, [MarshalAs(ut)] string filePath,
        PROGRESS_CALLBACK funProgress, IntPtr ctxProgress);
